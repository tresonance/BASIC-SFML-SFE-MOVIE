...
#include <SFE_MOVIES/sfeMovie/Movie.hpp>
#include <iostream>
#include <algorithm>
...
int main(void)
{
    ...
    const char *online_videos[] = {
        " https://download.blender.org/peach/bigbuckbunny_movies/BigBuckBunny_320x180.mp4",
        "/Volumes/DiskE/ONLINE_VIDEOS/BigBuckBunny_320x180.mp4",
        "/Volumes/DiskE/VIDEOS-Intro-mp4/Video_Intro.mp4"
    };
    
    std::string mediaFile = std::string(online_videos[2]);
